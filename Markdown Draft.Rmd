...
geom_point(data=comm11.prepdata_revised %>% filter(ID == unique(comm11.prepdata_revised$ID)[2]), aes(x=BNGX,y=BNGY, color = CONTBEH))+coord_fixed(ratio = 1, xlim = c(425000,430000+5000), ylim = c(600000, 600000+10000) )
```
